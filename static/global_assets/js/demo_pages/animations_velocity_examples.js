...
var AnimationsVelocityAdvanced = function() {
    ...
    var _componentAnimationVelocityAdvanced = function() {
        ...
        // Hide elements first
        $('.sidebar, .navbar, .navbar-brand, .navbar-text, .navbar-nav .nav-item, .page-header, .page-title, .page-header .header-elements, .breadcrumb, .breadcrumb-elements-item, .trainer_content > .card, .trainer_content .row > [class*=col-], .footer')
            .css('opacity', 0);
    };
    ...
    var _componentAnimationVelocityLayout = function() {
        ...
        // Layout parts - flex
        $('.navbar, .page-title, .page-header .header-elements, .breadcrumb, .trainer_content > .card, .footer')
            .css('opacity', 1)
        ...
        // Layout parts - block
        $('.navbar-brand, .navbar-text, .navbar-nav .nav-item, .page-header, .trainer_content .row > [class*=col-], .breadcrumb-elements-item')
            .css('opacity', 1)
